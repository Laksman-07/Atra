...
export const services = [
    {
      ...
      description: 'You bring the hustle, we bring the science.',
      extra:
    ...
    },
    {
      ...
      description: 'Custom strength programs tailored to your sport and goals.',
      extra:
    ...
    },
    {
      ...
      description: 'Focused rehabilitation programs to speed recovery safely.',
      extra:
